...
def listener():
	global pub1
	rospy.init_node('path_drone3', anonymous=True)
	frame_sub = rospy.Subscriber('/drone3/ROI_flow_initial', point_list, frameCallback)
	current_pos = rospy.Subscriber("/drone3/mavros/global_position/global", NavSatFix, current_callback)
	flags = rospy.Subscriber("/drone3/flags", local_flags, flag_callback)
