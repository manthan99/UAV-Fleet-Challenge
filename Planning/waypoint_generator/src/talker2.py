...
def talker():
    # pub = rospy.Publisher('/drone2/some_topic', point_list, queue_size=10)
    # gps = rospy.Publisher('/drone2/mavros/global_position/global', NavSatFix, queue_size=10)
    # height = rospy.Publisher('/drone2/mavros/local_position/pose',  PoseStamped, queue_size=10)
    # compass_hdg = rospy.Publisher('/drone2/mavros/global_position/compass_hdg', Float64, queue_size=10)
    # pub0 = rospy.Publisher('/drone0/chatter', point_list, queue_size=10)
    pub1 = rospy.Publisher('/drone2/probable_target_locations', point_list, queue_size=10)
    gps_pos = rospy.Subscriber("/drone2/mavros/global_position/global", NavSatFix, gps_callback)
