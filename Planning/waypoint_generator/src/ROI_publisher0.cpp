...
int main(int argc, char **argv)
{
	...
	ros::Subscriber frame_point_sub = n.subscribe("/drone0/some_topic", 1000, framePointCallback);
	...
	ros::Subscriber current_position = n.subscribe("/drone0/mavros/local_position/pose",10, localposcallback);
  	...
  	waypoint_pub = n.advertise<waypoint_generator::point_list>("/drone0/ROI_flow", 1000);
