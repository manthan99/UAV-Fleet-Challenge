...
def calculate_execute():
	...
	target_2.sip_start.x = 22.3218396
	target_2.sip_start.y = 87.3049858
	target_2.sip_end.x = 22.3219913
	target_2.sip_end.y = 87.3049727
...
def state2(data):
	...
	if(connected2 and armed2 and j < 10):
		print("execute: %d" % (j))
		calculate_execute()
		j += 1
